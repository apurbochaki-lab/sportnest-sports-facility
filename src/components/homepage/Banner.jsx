            ...
            <div className="container mx-auto pt-10 md:pt-20 flex flex-col-reverse md:flex-row justify-center  gap-10">
                ...
                <div className='m-5 pb-15 md:pb-0'>
                    ...
                    <Link href="/all-facilities">
                        <Button className="rounded-lg mt-10 flex justify-center mx-auto bg-[#dda15e] text-[#283618] hover:bg-[#bc6c25] text-xl font-bold p-6">Explore Facilities <FaLongArrowAltRight />
                        </Button>
                    </Link>
                </div>
