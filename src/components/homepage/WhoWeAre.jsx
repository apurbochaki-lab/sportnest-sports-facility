...
import img2 from '../../assets/who2.jpg'

const WhoWeAre = () => {
    return (
        <div className='pt-10 md:pt-20 container mx-auto'>

            <div className='flex flex-col-reverse md:flex-row justify-center gap-15'>
                <div className='md:pt-10 m-5 space-y-3'>
                    <p className='font-medium text-lg text-center md:text-left'>Our Ground</p>
                    <Image src={img1} alt='Image 1' height={800} width={450} className='shadow-xl rounded-lg border border-black/20' />
                </div>
                ...
                <div className='space-y-3 m-5'>
                    ...
                    <Image src={img2} alt='Image 2' height={500} width={350} className='shadow-xl rounded-lg border border-black/20 mx-auto md:mx-0' />
                </div>
            </div>
        </div>
    );
